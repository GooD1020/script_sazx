...
local Library = Update:Window("SAZX script","",Enum.KeyCode.RightControl);
Main = Library:Tab("Main")

Main:Line()

Main:Label("Welcome sazx script Community")
...
Main:Button("ไก่ตัน",function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/GooD1020/big-sazx/main/README.md"))()
end)

Main:Button("ปกติ",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/GooD1020/sazx_newui/main/README.md"))()
end)

Main:Button("by ui nero hub🥰",function()
